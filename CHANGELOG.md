...
- Implemented dynamic texture swaps for the Axe/Staff/Skull
- Updated Skull icon
- Added 7 minor prophecies
- Added 5 new hammer (10 total)
- Added 6 Chaos trials
- Added a set of Arcana backs
- Compat with Weapon-Fusion (By @Zerp on discord)
...
[unreleased]: https://github.com/Tal-lev/AspectYoungMel/compare/0.5.3...HEAD
